...
def train_esd(prompt, negative_prompt, p_unlearn, train_method, start_guidance, negative_guidance, iterations, lr, config_path, ckpt_path, diffusers_config_path, devices, seperator=None, image_size=512, ddim_steps=50):
    '''
...
if __name__ == '__main__':
    ...
    parser.add_argument('--negative_prompt', help='prompt of closely related concept to keep in the model', type=str, required=True)
    ...
    train_esd(prompt=prompt, negative_prompt=negative_prompt, p_unlearn=p_unlearn,
              train_method=train_method, start_guidance=start_guidance, negative_guidance=negative_guidance, iterations=iterations, lr=lr, config_path=config_path, ckpt_path=ckpt_path, diffusers_config_path=diffusers_config_path, devices=devices, seperator=seperator, image_size=image_size, ddim_steps=ddim_steps)
