    ...
    for i in range(10): # infinite loop is escaped by the return of the function
        ...
        completion = client.chat.completions.create(
            ...
            messages=[
                ...
                {"role": "user",
                 "content": "Generate a list of different, but similar concepts. Focus on concepts that are close semantically but look and are different."
                            ...
                            f"The concept to which you have to find similar, but different concepts is: {concept}."}
            ]
        )
